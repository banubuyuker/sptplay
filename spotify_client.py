...
REDIRECT_URI = os.getenv("SPOTIFY_REDIRECT_URI", "http://localhost:8080/auth/callback")
...
class SpotifyClient:
    ...
    async def update_playlist(self, playlist_id: str, name: str = None, description: str = None, public: bool = None) -> dict:
